package com.cssweb.log.rocketmq;
            ...
            public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs,
                ...
                if (msg.getTopic().equals("TopicTest1")) {
                    ...
                    if (msg.getTags() != null && msg.getTags().equals("TagA")) {
                        // 执行TagA的消费
                        System.out.println("TopicTest1 key=" + msg.getKeys() + ", body=" + new String(msg.getBody()));
                    }
                    ...
                    // 执行TopicTest2的消费逻辑
                    System.out.println("TopicTest2 key=" + msg.getKeys() + ", body=" + new String(msg.getBody()));
                }
